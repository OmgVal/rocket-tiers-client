...
export default function Welcome() {
	return (
		<div className="w-full h-screen flex flex-col justify-between">
			<div className="grid md:grid-cols-2 max-w-[1140px] m-auto">
				<div>
			...
			<div className="flex flex-col2 justify-center w-70 py-4 px-5">
				<div>
				...
				<div className="flex flex-col justify-right align-center md:items-start w-full h-full px-8 pt-5 mx-8">
					...
					<p className="">Rocket League is a fantastical sport-based video game, developed by Psyonix (it's “soccer with cars”). It features a competitive game mode based on teamwork and outmaneuvering opponents. Players work with their team to advance the ball down the field, and score goals in their opponents' net.</p>
				</div>
			</div>
							...
							<div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
								...
								<div className="p-6 hover:bg-indigo-700 hover:text-white transition duration-300 ease-in">
									<h2 className="text-base font-medium text-indigo-300 mb-1">September 7,
										2022</h2>
									<h1 className="text-2xl font-semibold mb-3">PATCH NOTES: SEASON 8 LIVE</h1>
									<div className="flex items-center flex-wrap ">
										<a className="text-cyan-300 inline-flex items-center md:mb-2 lg:mb-0">Read More
											<svg className="w-4 h-4 ml-2 animate-pulse" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"
												fill="none" strokeLinecap="round" strokeLinejoin="round">
							...
							<div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
								...
								<div className="p-6 hover:bg-indigo-700 hover:text-white transition duration-300 ease-in">
									<h2 className="text-base font-medium text-indigo-300 mb-1">July 20,
										2022</h2>
									<h1 className="text-2xl font-semibold mb-3">NIKE AIR ZOOM MERCURIAL ENTERS THE ROCKET LEAGUE ARENA</h1>
									<div className="flex items-center flex-wrap ">
										<a className="text-cyan-300 inline-flex items-center md:mb-2 lg:mb-0">Read More
											<svg className="w-4 h-4 ml-2 animate-pulse" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"
												fill="none" strokeLinecap="round" strokeLinejoin="round">
